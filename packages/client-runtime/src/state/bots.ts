...
import {
  ...
  type SaveChannelConnectionInput,
  type DeleteChannelConnectionInput,
  type AttachChannelInput,
  type DisconnectChannelInput,
  type DetachChannelInput,
...
export type {
  ...
  CreateBotInput,
  ConnectChannelInput,
  SaveChannelConnectionInput,
  DeleteChannelConnectionInput,
  AttachChannelInput,
...
export function createBotEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    channels: {
      saveConnection: createEnvironmentCommand(runtime, {
        label: "environment-data:commands:channel:connection:save",
        execute: (input: SaveChannelConnectionInput) => saveChannelConnection(input),
        scheduler,
      }),
      deleteConnection: createEnvironmentCommand(runtime, {
        label: "environment-data:commands:channel:connection:delete",
        execute: (input: DeleteChannelConnectionInput) => deleteChannelConnection(input),
        scheduler,
      }),
      attach: createEnvironmentCommand(runtime, {
        label: "environment-data:commands:channel:attach",
        execute: (input: AttachChannelInput) => attachChannel(input),
        scheduler,
        concurrency: botConcurrency,
      }),
      ...
      detach: createEnvironmentCommand(runtime, {
        label: "environment-data:commands:channel:detach",
        execute: (input: DetachChannelInput) => detachChannel(input),
        scheduler,
        concurrency: botConcurrency,
      }),
