...
export const AKERU_PAPER_THEME: ThemeDefinition = {
  id: "akeru-paper",
  label: "Akeru Paper",
  appearance: "light",
  colors: {
    canvas: "oklch(0.958531 0.009845 87.471)",
    chrome: "oklch(0.931632 0.012785 86.832)",
    toolbar: "oklch(0.958531 0.009845 87.471)",
    toolbarForeground: "oklch(0.274878 0.007028 67.529)",
    toolbarBorder: "oklch(0.847235 0.015219 80.702)",
    toolbarControl: "oklch(1 0 0)",
    toolbarControlForeground: "oklch(0.274878 0.007028 67.529)",
    toolbarControlHover: "oklch(0.908664 0.014962 80.705)",
    surface: "oklch(0.985526 0.005706 84.566)",
    surfaceRaised: "oklch(1 0 0)",
    surfaceOverlay: "oklch(1 0 0)",
    text: "oklch(0.274878 0.007028 67.529)",
    textMuted: "oklch(0.496285 0.012128 67.543)",
    border: "oklch(0.860421 0.015691 77.059)",
    input: "oklch(0.76072 0.017951 76.074)",
    focus: "oklch(0.607447 0.134946 296.512)",
    accent: "oklch(0.607447 0.134946 296.512)",
    accentForeground: "oklch(0.139671 0.024718 296.562)",
    secondary: "oklch(0.913953 0.014486 84.585)",
    secondaryForeground: "oklch(0.331371 0.010304 73.554)",
    muted: "oklch(0.937949 0.011528 84.579)",
    mutedForeground: "oklch(0.496285 0.012128 67.543)",
    placeholder: "oklch(0.496285 0.012128 67.543)",
    secondaryLabel: "oklch(0.496285 0.012128 67.543)",
    iconMuted: "oklch(0.496285 0.012128 67.543)",
    error: "oklch(0.542323 0.154141 26.861)",
    errorForeground: "oklch(0.443931 0.131056 26.805)",
    errorSurface: "oklch(0.931623 0.019109 29.549)",
    warning: "oklch(0.566615 0.126823 65.303)",
    warningForeground: "oklch(0.442827 0.097381 67.7)",
    warningSurface: "oklch(0.943016 0.035404 85.408)",
    update: "oklch(0.607447 0.134946 296.512)",
    updateForeground: "oklch(0.449304 0.145439 295.863)",
    updateSurface: "oklch(0.940347 0.022271 302.929)",
    accentSurface: "oklch(0.912658 0.033973 304.531)",
    accentSurfaceForeground: "oklch(0.449304 0.145439 295.863)",
    messageSurface: "oklch(0.945777 0.019688 305.262)",
    messageForeground: "oklch(0.274878 0.007028 67.529)",
    messageAction: "oklch(0.607447 0.134946 296.512)",
    messageActionForeground: "oklch(0.139671 0.024718 296.562)",
    messageActionHover: "oklch(0.656453 0.13742 297.344)",
    codeBackground: "oklch(0.931901 0.011546 84.579)",
    codeForeground: "oklch(0.274878 0.007028 67.529)",
    sidebar: "oklch(0.931632 0.012785 86.832)",
    sidebarForeground: "oklch(0.274878 0.007028 67.529)",
    sidebarMutedForeground: "oklch(0.496285 0.012128 67.543)",
    sidebarControlSurface: "oklch(0.970803 0.008582 84.573)",
    sidebarRowHover: "oklch(0.958531 0.009845 87.471)",
    sidebarRowActive: "oklch(1 0 0)",
    sidebarRowSelected: "oklch(1 0 0)",
    sidebarBorder: "oklch(0.860421 0.015691 77.059)",
    terminalBackground: "oklch(0.249565 0.003571 48.579)",
    terminalForeground: "oklch(0.950015 0.011492 84.579)",
    terminalCursor: "oklch(0.607447 0.134946 296.512)",
    terminalSelection: "oklch(0.912658 0.033973 304.531)",
    terminalScrollbar: "oklch(0.459577 0.01156 72.528)",
    terminalScrollbarHover: "oklch(0.551879 0.013009 71.789)",
  },
  variants: {
    dark: {
      canvas: "oklch(0.114918 0 0)",
      chrome: "oklch(0.177638 0 0)",
      toolbar: "oklch(0.114918 0 0)",
      toolbarForeground: "oklch(0.967434 0.001326 286.375)",
      toolbarBorder: "oklch(0.28908 0 0)",
      toolbarControl: "oklch(0.222129 0 0)",
      toolbarControlForeground: "oklch(0.967434 0.001326 286.375)",
      toolbarControlHover: "oklch(0.268618 0 0)",
      surface: "oklch(0.209036 0 0)",
      surfaceRaised: "oklch(0.305191 0 0)",
      surfaceOverlay: "oklch(0.177638 0 0)",
      text: "oklch(0.967434 0.001326 286.375)",
      textMuted: "oklch(0.711815 0.012937 286.067)",
      border: "oklch(0.28908 0 0)",
      input: "oklch(0.370323 0.01188 285.805)",
      focus: "oklch(0.607447 0.134946 296.512)",
      accent: "oklch(0.607447 0.134946 296.512)",
      accentForeground: "oklch(0.139671 0.024718 296.562)",
      secondary: "oklch(0.268618 0 0)",
      secondaryForeground: "oklch(0.967434 0.001326 286.375)",
      muted: "oklch(0.222129 0 0)",
      mutedForeground: "oklch(0.711815 0.012937 286.067)",
      placeholder: "oklch(0.711815 0.012937 286.067)",
      secondaryLabel: "oklch(0.711815 0.012937 286.067)",
      iconMuted: "oklch(0.711815 0.012937 286.067)",
      error: "oklch(0.665241 0.148078 26.77)",
      errorForeground: "oklch(0.772758 0.103326 25.58)",
      errorSurface: "oklch(0.289862 0.032452 25.297)",
      warning: "oklch(0.758152 0.10943 78.772)",
      warningForeground: "oklch(0.855925 0.082896 82.001)",
      warningSurface: "oklch(0.309837 0.024833 79.663)",
      update: "oklch(0.607447 0.134946 296.512)",
      updateForeground: "oklch(0.80327 0.077482 299.92)",
      updateSurface: "oklch(0.269917 0.050751 301.875)",
      accentSurface: "oklch(0.268618 0 0)",
      accentSurfaceForeground: "oklch(0.967434 0.001326 286.375)",
      messageSurface: "oklch(0.370323 0.01188 285.805)",
      messageForeground: "oklch(0.967434 0.001326 286.375)",
      messageAction: "oklch(0.607447 0.134946 296.512)",
      messageActionForeground: "oklch(0.139671 0.024718 296.562)",
      messageActionHover: "oklch(0.656453 0.13742 297.344)",
      codeBackground: "oklch(0.177638 0 0)",
      codeForeground: "oklch(0.967434 0.001326 286.375)",
      sidebar: "oklch(0.177638 0 0)",
      sidebarForeground: "oklch(0.967434 0.001326 286.375)",
      sidebarMutedForeground: "oklch(0.711815 0.012937 286.067)",
      sidebarControlSurface: "oklch(0.222129 0 0)",
      sidebarRowHover: "oklch(0.243535 0 0)",
      sidebarRowActive: "oklch(0.268618 0 0)",
      sidebarRowSelected: "oklch(0.28908 0 0)",
      sidebarBorder: "oklch(0.28908 0 0)",
      terminalBackground: "oklch(0.114918 0 0)",
      terminalForeground: "oklch(0.967434 0.001326 286.375)",
      terminalCursor: "oklch(0.656453 0.13742 297.344)",
      terminalSelection: "oklch(0.358238 0.073841 303.758)",
      terminalScrollbar: "oklch(0.321093 0 0)",
      terminalScrollbarHover: "oklch(0.4 0 0)",
    },
  },
};

/**
 * The Grok Bot-inspired flagship chassis: neutral near-black surfaces with
 * pill-shaped controls and the Akeru purple reserved for actions and focus.
 */
export const AKERU_NOIR_THEME: ThemeDefinition = {
  id: "akeru-noir",
  label: "Akeru Noir",
  appearance: "light",
  colors: {
    canvas: "oklch(0.99 0.001 286.375)",
    chrome: "oklch(0.975 0.0015 286.375)",
    toolbar: "oklch(0.99 0.001 286.375)",
    toolbarForeground: "oklch(0.21 0.006 285.885)",
    toolbarBorder: "oklch(0.92 0.003 286.32)",
    toolbarControl: "oklch(1 0 0)",
    toolbarControlForeground: "oklch(0.21 0.006 285.885)",
    toolbarControlHover: "oklch(0.945 0.003 286.32)",
    surface: "oklch(0.985 0.0012 286.375)",
    surfaceRaised: "oklch(1 0 0)",
    surfaceOverlay: "oklch(1 0 0)",
    text: "oklch(0.21 0.006 285.885)",
    textMuted: "oklch(0.55 0.012 285.938)",
    border: "oklch(0.92 0.004 286.32)",
    input: "oklch(0.87 0.005 286.32)",
    focus: "oklch(0.607447 0.134946 296.512)",
    accent: "oklch(0.607447 0.134946 296.512)",
    accentForeground: "oklch(0.139671 0.024718 296.562)",
    secondary: "oklch(0.945 0.003 286.32)",
    secondaryForeground: "oklch(0.21 0.006 285.885)",
    muted: "oklch(0.955 0.0025 286.32)",
    mutedForeground: "oklch(0.5 0.012 285.938)",
    placeholder: "oklch(0.55 0.012 285.938)",
    secondaryLabel: "oklch(0.5 0.012 285.938)",
    iconMuted: "oklch(0.52 0.012 285.938)",
    error: "oklch(0.542323 0.154141 26.861)",
    errorForeground: "oklch(0.443931 0.131056 26.805)",
    errorSurface: "oklch(0.931623 0.019109 29.549)",
    warning: "oklch(0.566615 0.126823 65.303)",
    ...
    updateForeground: "oklch(0.449304 0.145439 295.863)",
    updateSurface: "oklch(0.940347 0.022271 302.929)",
    accentSurface: "oklch(0.945 0.003 286.32)",
    accentSurfaceForeground: "oklch(0.21 0.006 285.885)",
    messageSurface: "oklch(0.94 0.004 286.32)",
    messageForeground: "oklch(0.21 0.006 285.885)",
    messageAction: "oklch(0.607447 0.134946 296.512)",
    messageActionForeground: "oklch(0.139671 0.024718 296.562)",
    messageActionHover: "oklch(0.656453 0.13742 297.344)",
    codeBackground: "oklch(0.965 0.002 286.32)",
    codeForeground: "oklch(0.21 0.006 285.885)",
    sidebar: "oklch(0.975 0.0015 286.375)",
    sidebarForeground: "oklch(0.21 0.006 285.885)",
    sidebarMutedForeground: "oklch(0.5 0.012 285.938)",
    sidebarControlSurface: "oklch(0.95 0.003 286.32)",
    sidebarRowHover: "oklch(0.95 0.003 286.32)",
    sidebarRowActive: "oklch(1 0 0)",
    sidebarRowSelected: "oklch(1 0 0)",
    sidebarBorder: "oklch(0.92 0.003 286.32)",
    terminalBackground: "oklch(0.99 0.001 286.375)",
    terminalForeground: "oklch(0.21 0.006 285.885)",
    terminalCursor: "oklch(0.607447 0.134946 296.512)",
    terminalSelection: "oklch(0.912658 0.033973 304.531)",
    terminalScrollbar: "oklch(0.83 0.004 286.32)",
    terminalScrollbarHover: "oklch(0.75 0.005 286.32)",
  },
  variants: {
    dark: {
      canvas: "oklch(0.105 0 0)",
      chrome: "oklch(0.135 0 0)",
      toolbar: "oklch(0.105 0 0)",
      toolbarForeground: "oklch(0.97 0.0013 286.375)",
      toolbarBorder: "oklch(0.225 0 0)",
      toolbarControl: "oklch(0.19 0 0)",
      toolbarControlForeground: "oklch(0.97 0.0013 286.375)",
      toolbarControlHover: "oklch(0.24 0 0)",
      surface: "oklch(0.16 0 0)",
      surfaceRaised: "oklch(0.225 0 0)",
      surfaceOverlay: "oklch(0.175 0 0)",
      text: "oklch(0.97 0.0013 286.375)",
      textMuted: "oklch(0.594 0.008 286.067)",
      border: "oklch(0.235 0 0)",
      input: "oklch(0.3 0 0)",
      focus: "oklch(0.607447 0.134946 296.512)",
      accent: "oklch(0.607447 0.134946 296.512)",
      accentForeground: "oklch(0.14 0.0247 296.562)",
      secondary: "oklch(0.225 0 0)",
      secondaryForeground: "oklch(0.97 0.0013 286.375)",
      muted: "oklch(0.19 0 0)",
      mutedForeground: "oklch(0.68 0.008 286.067)",
      placeholder: "oklch(0.63 0.008 286.067)",
      secondaryLabel: "oklch(0.68 0.008 286.067)",
      iconMuted: "oklch(0.65 0.008 286.067)",
      error: "oklch(0.665241 0.148078 26.77)",
      errorForeground: "oklch(0.772758 0.103326 25.58)",
      errorSurface: "oklch(0.289862 0.032452 25.297)",
      warning: "oklch(0.758152 0.10943 78.772)",
      ...
      updateForeground: "oklch(0.80327 0.077482 299.92)",
      updateSurface: "oklch(0.269917 0.050751 301.875)",
      accentSurface: "oklch(0.235 0 0)",
      accentSurfaceForeground: "oklch(0.97 0.0013 286.375)",
      messageSurface: "oklch(0.25 0 0)",
      messageForeground: "oklch(0.97 0.0013 286.375)",
      messageAction: "oklch(0.607447 0.134946 296.512)",
      messageActionForeground: "oklch(0.139671 0.024718 296.562)",
      messageActionHover: "oklch(0.656453 0.13742 297.344)",
      codeBackground: "oklch(0.145 0 0)",
      codeForeground: "oklch(0.97 0.0013 286.375)",
      sidebar: "oklch(0.135 0 0)",
      sidebarForeground: "oklch(0.97 0.0013 286.375)",
      sidebarMutedForeground: "oklch(0.7 0.008 286.067)",
      sidebarControlSurface: "oklch(0.185 0 0)",
      sidebarRowHover: "oklch(0.185 0 0)",
      sidebarRowActive: "oklch(0.215 0 0)",
      sidebarRowSelected: "oklch(0.235 0 0)",
      sidebarBorder: "oklch(0.215 0 0)",
      terminalBackground: "oklch(0.105 0 0)",
      terminalForeground: "oklch(0.97 0.0013 286.375)",
      terminalCursor: "oklch(0.607447 0.134946 296.512)",
      terminalSelection: "oklch(0.358238 0.073841 303.758)",
      terminalScrollbar: "oklch(0.27 0 0)",
      terminalScrollbarHover: "oklch(0.4 0 0)",
    },
  },
};
