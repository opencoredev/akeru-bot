...
Akeru Bot keeps accepted feedback for 90 days. Turn off **Product feedback** in **Settings → About** to disable sending. Self-hosted environments can set an HTTPS endpoint there. Loopback HTTP endpoints are allowed for local testing.
