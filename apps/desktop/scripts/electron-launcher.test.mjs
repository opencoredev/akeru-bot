...
describe("electron development launcher", () => {
  ...
  it("keeps the native Electron executable name inside the branded macOS bundle", () => {
    const paths = resolveMacLauncherPaths(
      "/repo/apps/desktop/.electron-runtime/Akeru Bot (Dev).app",
      "Akeru Bot (Dev)",
    );

    assert.equal(paths.launcherExecutableName, "Akeru Bot (Dev) Launcher");
    assert.equal(
      paths.launcherBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Akeru Bot (Dev).app/Contents/MacOS/Akeru Bot (Dev) Launcher",
    );
    assert.equal(
      paths.runtimeElectronBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Akeru Bot (Dev).app/Contents/MacOS/Electron",
    );
