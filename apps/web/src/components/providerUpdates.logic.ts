...
/**
 * The sidebar pill reports progress and outcome of an update the user started
 * from provider settings. Passive update availability never produces a pill;
 * that state is only shown inline in Settings → Providers.
 */
