...
const ProviderUsageHistoryLayerLive = ProviderUsageHistory.layer.pipe(
  Layer.provide(SqlitePersistenceLayerLive),
);
const UsageLayerLive = UsageService.layer.pipe(Layer.provide(ProviderUsageHistoryLayerLive));
...
const LegacyProviderLayerLive = LegacyProviderBridgeLive.pipe(
