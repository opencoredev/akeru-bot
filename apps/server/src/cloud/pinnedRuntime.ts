...
/**
 * A pinned runtime is an exact `akeru-bot@<version>` npm-installed into
 ...
 * switching over, never `npx akeru-bot`, whose cache is ephemeral and whose
...
/**
 * Installs `akeru-bot@<version>` into the pinned runtime directory unless a complete
