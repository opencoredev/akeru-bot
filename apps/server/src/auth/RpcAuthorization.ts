...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.composioSearchToolkits]: AuthOrchestrationReadScope,
  [WS_METHODS.composioAuthorize]: AuthOrchestrationOperateScope,
  [WS_METHODS.composioDisconnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.subscriptionAuthList]: AuthOrchestrationReadScope,
  [WS_METHODS.subscriptionAuthStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.subscriptionAuthPoll]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.memoryInspect]: AuthOrchestrationReadScope,
