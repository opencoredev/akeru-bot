/**
 * `akeru triage` - hand a misbehaving install to the user's own coding agent.
 *
...
export const triageCommand = Command.make("triage", {
  ...
  Command.withDescription(
    "Investigate an Akeru Bot problem on this machine with claude or codex, and help file a good issue.",
  ),
